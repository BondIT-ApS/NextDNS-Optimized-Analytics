...
class TestInvalidateMemoryCache:
    ...
    def test_multiple_profiles_only_target_cleared(self):
        ...
        assert f"overview:profile_a:range_24h" in stats_cache._MEMORY_CACHE
        assert f"overview:profile_b:range_24h" not in stats_cache._MEMORY_CACHE
        assert f"overview:profile_c:range_24h" in stats_cache._MEMORY_CACHE
